...
const experiences = [
  ...
  },
  {
    ...
    achievements: [
      ...
      'Single handily owned and resolved multiple critical CIA issues with Sev 1 priority to unblock customers in production environments.', 
      'Improved UI efficiency by 75% through critical issue resolution, debugging, and backlog item management.',
      'Implemented OAuth 2.0 and JWT-based authentication systems',
      'Mentored and led a team of three junior engineers (SE-1) and five software engineering interns to significantly reduce the bug backlog, achieving improved response times and team efficiency.',
  ...
  },
  {
    ...
    type: 'MISSION_BETA',
    achievements: [
      'Managed post-go-live solutions and customizations of the ICI product using the .NET framework.', 
      'Developed SQL queries to generate precise data reports of failed transactions, facilitating efficient backlog processing and issue resolution.',
