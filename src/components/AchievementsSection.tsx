...
const achievements = [
  {
    ...
    year: '2024',
    description: 'Recognized for exceptional performance and contributions to platform engineering team.',
    icon: Trophy,
    rarity: 'LEGENDARY',
    color: 'cyber-orange',
  },
  ...
  },
  {
    ...
    year: '2019',
    description: 'Nominated for AICTE Chattra Vishwakarma Awards among 56000+ projects across India.',
    icon: Award,
    rarity: 'RARE',
    color: 'cyber-accent',
  },
  {
    ...
    organization: 'University CTF League & Ericsson',
    year: '2025',
  ...
  },
  {
    ...
    year: '2023',
    description: 'Professional certification in Azure Administrator',
    icon: Award,
    rarity: 'COMMON',
    color: 'cyber-accent',
  },
  {
    ...
    organization: 'Microsoft',
    year: '2024',
    description: 'Professional certification in Azure AI Fundamentals',
    icon: Award,
    rarity: 'COMMON',
    color: 'cyber-accent',
  },
